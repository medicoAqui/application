package com.example.gabriela.medicoaqui.Activity.Adapters;
...
public class PerguntasFrequentesAdaptador extends BaseExpandableListAdapter {

    private List<String> lstGrupos;
    private HashMap<String, List<Resposta>> lstItensGrupos;
    private Context context;

    public PerguntasFrequentesAdaptador(Context context, List<String> grupos, HashMap<String, List<Resposta>> itensGrupos) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        Resposta resposta = (Resposta) getChild(groupPosition, childPosition);
        tvItem.setText(resposta.getNome());
        return convertView;
    }
